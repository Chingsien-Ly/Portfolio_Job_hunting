...
function Header() {
  ...
  return (
    <div className="w-full h-[72px] p-2 flex bg-[#242728] items-center justify-between">
      {/* left */}
      <div className="flex items-center gap-2 flex-1">
        ...
        {/* input */}
        <div className="flex p-2  gap-3 rounded-4xl bg-[#333334] items-center ">
          <svg
            width="20px"
            height="20px"
            viewBox="0 0 24 24"
          ...
          <input
            ...
            className="w-full text-[#a8abb0] focus:outline-none"
          />
        </div>
      </div>
      {/* middle */}
      <div className="flex flex-2  h-[72px] items-center justify-between px-5 ">
        <div className="flex w-[15%] h-full relative items-center justify-center">
          <svg
            viewBox="0 0 24 24"
            width="30"
            height="30"
            fill="#0966ff"
            className="x14rh7hd x1lliihq x1tzjh5l x1k90msu x2h7rmj x1qfuztqx h-[80%]"
          >
          ...
          {/* indicator */}
          <div className=" bg-[#0966ff] h-1 w-full absolute bottom-0"></div>
        </div>
        <div className="w-[15%] h-full flex items-center justify-center">
          <div className="h-[80%] flex items-center justify-center w-full hover:bg-[#333334] cursor-pointer hover:rounded-2xl">
            <svg
              viewBox="0 0 24 24"
              width="30"
              height="30"
      ...
      <div className="flex flex-1 items-center justify-end gap-4">
        <div className="size-10 bg-[#333334] flex items-center justify-center rounded-full cursor-pointer">
          <svg
            viewBox="0 0 24 24"
            width="20"
            height="20"
        ...
        {/* Notification */}
        <div className="size-10 bg-[#273953] flex items-center justify-center rounded-full cursor-pointer relative ">
          <svg
            viewBox="0 0 24 24"
            width="20"
            height="20"
          ...
          <div className="size-5 bg-red-600 flex items-center justify-center text-white rounded-full text-sm absolute -top-1.5 -right-1.5">
            1
          </div>
          {/* nofitication component */}
